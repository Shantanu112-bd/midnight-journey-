...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      createAgreement: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const publicTitle_0 = args_1[1];
        const privateAgreementDetailsHash_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(publicTitle_0).concat(_descriptor_1.toValue(privateAgreementDetailsHash_0)),
        ...
        const result_0 = this._createAgreement_0(context,
                                                 partialProofData,
                                                 publicTitle_0,
                                                 privateAgreementDetailsHash_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      verifyAgreement: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`verifyAgreement: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        const result_0 = this._verifyAgreement_0(context,
                                                 partialProofData,
                                                 expectedHash_0);
      ...
      fileComplaint: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const encryptedComplaintHash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(encryptedComplaintHash_0),
            alignment: _descriptor_1.alignment()
          },
          output: undefined,
          publicTranscript: [],
      ...
      castPrivateVote: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(proposalId_0).concat(_descriptor_0.toValue(voteChoice_0)),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(privateAgreementDetailsHash_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
  ...
  _verifyAgreement_0(context, partialProofData, expectedHash_0) {
